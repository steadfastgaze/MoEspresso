...
_COUNT_KEYS = (
    ...
    "iqk_gemv_calls",
    "iqk_gemv_pairs",
    "iqk_sorted_prefill_calls",
    "iqk_sorted_prefill_pairs",
    "iqk_sorted_nsplit_calls",
    "iqk_sorted_nsplit_parts",
    "built_dequant_range_kernel_count",
    "built_iqk_dual_gemv_kernel_count",
    "ds4_drafter_policy_auto_on",
    "ds4_drafter_policy_auto_off",
    ...
    "kquant_bulk_kernel_calls",
    "kquant_bulk_bridge_calls",
    "q8_hc_post_engaged_calls",
    "q8_hc_post_fallback_calls",
    "q8_hc_post_delegated_calls",
    "q8_ffn_hc_post_engaged_calls",
    "q8_ffn_hc_post_fallback_calls",
    "q8_ffn_hc_post_delegated_calls",
    "iqk_dense_decode_gemv_calls",
    ...
    "iqk_dense_wo_a_gather_calls",
    "iqk_dense_wo_a_bulk_calls",
    "iqk_dense_delegated_calls",
